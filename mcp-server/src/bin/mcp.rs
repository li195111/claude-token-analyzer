...
impl TokenAnalyzerServer {
    ...
    #[tool(
        name = "sync_db",
        description = "Synchronize the database by scanning all JSONL session files under ~/.claude/projects/ and upserting new or modified sessions. Returns a sync report with counts of files scanned, synced, and failed."
    )]
